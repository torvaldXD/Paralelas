...
class NodeManagerServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CancelTasksWithResourceShapes = channel.unary_unary(
                '/ray.rpc.NodeManagerService/CancelTasksWithResourceShapes',
                request_serializer=src_dot_ray_dot_protobuf_dot_node__manager__pb2.CancelTasksWithResourceShapesRequest.SerializeToString,
                response_deserializer=src_dot_ray_dot_protobuf_dot_node__manager__pb2.CancelTasksWithResourceShapesReply.FromString,
                )
...
class NodeManagerServiceServicer(object):
    ...
    def CancelTasksWithResourceShapes(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_NodeManagerServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'CancelTasksWithResourceShapes': grpc.unary_unary_rpc_method_handler(
                    servicer.CancelTasksWithResourceShapes,
                    request_deserializer=src_dot_ray_dot_protobuf_dot_node__manager__pb2.CancelTasksWithResourceShapesRequest.FromString,
                    response_serializer=src_dot_ray_dot_protobuf_dot_node__manager__pb2.CancelTasksWithResourceShapesReply.SerializeToString,
            ),
...
class NodeManagerService(object):
    ...
    @staticmethod
    def CancelTasksWithResourceShapes(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ray.rpc.NodeManagerService/CancelTasksWithResourceShapes',
            src_dot_ray_dot_protobuf_dot_node__manager__pb2.CancelTasksWithResourceShapesRequest.SerializeToString,
            src_dot_ray_dot_protobuf_dot_node__manager__pb2.CancelTasksWithResourceShapesReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
